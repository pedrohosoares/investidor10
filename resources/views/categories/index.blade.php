            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex space-x-2">
                    <a href="{{ route('categories.create') }}" rel="Nova categoria" type="button"
                        class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">{{ __('Nova Categoria') }}</a>
                </div>
                                                ...
                                                <td
                                                    ...
                                                    <a href="{{ route('categories.edit', $category->id) }}"
                                                        ...
                                                        <svg style="width:24px;height:24px;"
                                                            ...
                                                            width="920.729px" height="920.729px"
                                                            viewBox="0 0 920.729 920.729"
                                                            style="enable-background:new 0 0 920.729 920.729;"
                                                            xml:space="preserve">
                                                            <g>
                                                                <path
                                                                ...
                                                                <path
                                                                    d="M755.891,191.529c26.7-31.7,22.6-79-9.1-105.7l-81.101-68.2c-31.7-26.7-79-22.6-105.7,9.1l-32.1,38.1l195.9,164.8   L755.891,191.529z" />
                                                                <polygon
                                                                    points="698.891,258.629 502.991,93.829 436.591,172.829 632.491,337.629  " />
                                                                <path
                                                                    d="M0.091,877.43c-0.5,6.8,5.8,12.1,12.4,10.399l49.5-12.5l-58.2-49L0.091,877.43z" />
                                                                <path
                                                                    d="M236.69,807.229l367.701-436.8l-195.901-164.8l-367.7,436.7c-6.8,8.101-10.9,18.101-11.6,28.601l-8.7,120.8l72.8,61.3   l117.3-29.5C220.791,820.93,229.891,815.229,236.69,807.229z" />
                                                            </g>
                                                            <g> </g>
                                                            <g> </g>
                                                            <g> </g>
                                                    ...
                                                    <form method="POST"
                                                        ...
                                                        <button type="submit" rel="Excluir">
                                                            <svg style="width:24px;height:24px;"
                                                                ...
                                                                y="0px" width="482.428px" height="482.429px"
